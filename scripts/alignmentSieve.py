# -*-coding:utf-8 -*-
# ============================================================
# File    :   alignmentSieve.py
# Time    :   2023/06/16 11:24:41
# Author  :   dengxsh
# Version :   1.0
# Contact :   920466915@qq.com
# License :   Copyright (c) 2023, dengxsh
# Desc    :   modify from deeptools alignmentSieve.py 
# ============================================================
...
def shiftRead(b, chromDict, args):
    ...
    # create a new read
    b.reference_start = start
    b.cigar = ((0, end - start),)  # Returned cigar is only matches
    if tLen < 0:
        b.template_length = tLen - deltaTLen
    else:
        b.template_length = tLen + deltaTLen
    if b.is_proper_pair:
        if b.is_read2 and b.is_reverse:
            b.next_reference_start += args.shift[0]
        elif not b.is_read2 and b.is_reverse:
            b.next_reference_start -= args.shift[3]
    return b
