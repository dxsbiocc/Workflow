...
class Wrapper(WrapperBase):
    ...
    def run(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            shell("mv {tmpdir}/out.cis.vecs.tsv {self.snakemake.output.vecs}")
            shell("mv {tmpdir}/out.cis.lam.txt {self.snakemake.output.lam}")
            if self.bigwig:
                shell("mv {tmpdir}/out.cis.bw {self.snakemake.output.bigwig}")
